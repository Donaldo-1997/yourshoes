...
import { putCreatedProduct, getShoeById, getAllBrands, getDetails } from '../../redux/actions'
...
export default function EditProduct(){
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        dispatch(putCreatedProduct({id: id, input}))
        setInput({
            title: "",
            model: "",
            image: "",
                ...
                <form onSubmit={(e) => handleSubmit(e)} className={styles.form}>
                    ...
                    <div className={styles.tallesContainer}>
                        ...
                        <ul className={styles.ulTalles}>
                            {input.size && input.size.map(talle => <li key={talle} className={styles.liTalle}>{talle}<button value={talle} onClick={(e) => handleDeleteSize(e)} className={styles.xButton}>x</button></li>)}
                        </ul>
                    </div>
