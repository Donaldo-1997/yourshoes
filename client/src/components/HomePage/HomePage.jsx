...
export default function HomePage() {
  ...
  const handleNameSubmit = (e) => {
    ...
    if (
      ...
      dispatch(
        combinationsFilter9(categoryFilter, nameFilter, priceMin, priceMax)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
  ...
  const handleFilterBrand = (e) => {
    ...
    if (
      ...
      dispatch(
        combinationsFilter11(e.target.value, priceMin, priceMax, sizeFilter)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
    } else if (priceMax !== "" && priceMin !== "" && nameFilter !== "") {
      dispatch(
        combinationsFilter2(e.target.value, nameFilter, priceMin, priceMax)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
    } else if (
      ...
      dispatch(
        combinationsFilter8(categoryFilter, e.target.value, priceMax, priceMin)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
  ...
  const handleCategories = (e) => {
    ...
    if (
      ...
      dispatch(
        combinationsFilter9(e.target.value, nameFilter, priceMin, priceMax)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
  ...
  const handleFilterByPrice = (e) => {
    ...
    if (
      ...
      dispatch(
        combinationsFilter11(brandFilter, priceMin, priceMax, sizeFilter)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
    } else if (brandFilter !== "default" && categoryFilter !== "default") {
      dispatch(
        combinationsFilter8(categoryFilter, brandFilter, priceMax, priceMin)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
  ...
  const handleSize = (e) => {
    ...
    if (priceMin !== "" && priceMax !== "" && brandFilter !== "default") {
      dispatch(
        combinationsFilter11(brandFilter, priceMin, priceMax, e.target.value)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
    } else if (brandFilter !== "default" && categoryFilter !== "default") {
      dispatch(
        combinationsFilter17(e.target.value, categoryFilter, brandFilter)
      )
        .then((res) => console.log(res))
        .catch((err) => alert(err.response.data));
