      ...
      <div>
        ...
        {infoUser ? (
          <div>
            ...
            <div className={styles.nameContainer}>{infoUser.nickname === null ? <><p className={styles.userName}>Nombre de usuario: </p><h2 className={styles.userData}>Debes agregar un nombre de usuario</h2></> : <><p className={styles.userName}>Nombre de usuario: </p><h2 className={styles.userData}>{infoUser.nickname}</h2></>}</div>
