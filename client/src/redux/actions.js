...
export function filterByPrice(priceMin, priceMax) {
  ...
  return async function (dispatch) {
    const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?priceMin=${priceMin}&priceMax=${priceMax}`)
    return dispatch({
...
export function createOrder(payload) {
  return async function (dispatch) {
    const res = await axios.post(`https://yourshoes-back.herokuapp.com/mercadopago`, { cart: payload.cart });
    return dispatch({
      type: "CREATE_ORDER",
      payload: res.data,
    });
...
export function combinationsFilter(brand, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?brand=${brand}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter1(name, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?name=${name}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter2(brand, name, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?brand=${brand}&name=${name}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter3(name, brand) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?name=${name}&brand=${brand}`)
      dispatch({
...
export function combinationsFilter4(category, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter5(category, name) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&name=${name}`)
      dispatch({
...
export function combinationsFilter6(brand, category) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?brand=${brand}&category=${category}`)
      dispatch({
...
export function combinationsFilter7(category, brand, name) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&brand=${brand}&name=${name}`)
      dispatch({
...
export function combinationsFilter8(category, brand, priceMax, priceMin) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&brand=${brand}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter9(category, name, priceMax, priceMin) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&name=${name}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter10(category, name, priceMax, priceMin, brand) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?category=${category}&name=${name}&brand=${brand}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter11(brand, priceMin, priceMax, size) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?size=${size}&brand=${brand}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter_12(size, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?size=${size}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter_13(size, brand) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?size=${size}&brand=${brand}`)
      dispatch({
...
export function combinationsFilter14(size, brand, name, priceMin, priceMax) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?size=${size}&brand=${brand}&name=${name}&priceMin=${priceMin}&priceMax=${priceMax}`)
      dispatch({
...
export function combinationsFilter15(size, name) {
  return async function (dispatch) {
    try {
      const results = await axios(`https://yourshoes-back.herokuapp.com/shoes?size=${size}&name=${name}`)
      dispatch({
